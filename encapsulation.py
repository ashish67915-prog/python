class ATM:
    ...
    def __init__(self):
        self.pin = ''
        self.__balance = 0  #note in  python nothing is truly private here we also access it by using  _ATM__balance but we understand that this is wrong we donot have to do this because it is the private member of the class so we donot disturb it(own responsibility)
